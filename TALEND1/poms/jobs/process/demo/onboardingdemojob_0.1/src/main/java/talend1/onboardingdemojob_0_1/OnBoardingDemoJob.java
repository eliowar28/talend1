...
package talend1.onboardingdemojob_0_1;
...
public class OnBoardingDemoJob implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "OnBoardingDemoJob.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(OnBoardingDemoJob.class);
	...
	private final String projectName = "TALEND1";
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALEND1_OnBoardingDemoJob = new byte[0];
		static byte[] commonByteArray_TALEND1_OnBoardingDemoJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND1_OnBoardingDemoJob.length) {
					if (length < 1024 && commonByteArray_TALEND1_OnBoardingDemoJob.length == 0) {
						commonByteArray_TALEND1_OnBoardingDemoJob = new byte[1024];
					} else {
						commonByteArray_TALEND1_OnBoardingDemoJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND1_OnBoardingDemoJob, 0, length);
				strReturn = new String(commonByteArray_TALEND1_OnBoardingDemoJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALEND1_OnBoardingDemoJob, 0, length);
				strReturn = new String(commonByteArray_TALEND1_OnBoardingDemoJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND1_OnBoardingDemoJob) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		...
		if (exitCode == 0) {
			log.info("TalendJob: 'OnBoardingDemoJob' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'OnBoardingDemoJob' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_QKNNUGZ8EeWm5YvsrIoYzQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-04-14T22:43:45.389443Z");
		...
		try {
			...
			java.io.InputStream inContext = OnBoardingDemoJob.class.getClassLoader()
					.getResourceAsStream("talend1/onboardingdemojob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
		...
		log.info("TalendJob: 'OnBoardingDemoJob' - Started.");
		...
		log.info("TalendJob: 'OnBoardingDemoJob' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 63703 characters generated by Talend Cloud Data Management Platform on the
 * April 14, 2025 at 5:43:45 PM COT
 ************************************************************************************************/